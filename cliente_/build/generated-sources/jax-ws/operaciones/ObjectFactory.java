 ...
 * generated in the operaciones package. 
...
public class ObjectFactory {
    ...
    private final static QName _Dividir_QNAME = new QName("http://operaciones/", "dividir");
    private final static QName _DividirResponse_QNAME = new QName("http://operaciones/", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://operaciones/", "multiplicar");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://operaciones/", "multiplicarResponse");
    private final static QName _Restar_QNAME = new QName("http://operaciones/", "restar");
    private final static QName _RestarResponse_QNAME = new QName("http://operaciones/", "restarResponse");
    private final static QName _Sumar_QNAME = new QName("http://operaciones/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://operaciones/", "sumarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: operaciones
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "restar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "restarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operaciones/", name = "sumarResponse")
