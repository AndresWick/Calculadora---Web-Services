 ...
 * 
 */
@WebServiceClient(name = "Calculadora", targetNamespace = "http://operaciones/", wsdlLocation = "http://localhost:8080/calculadora_/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORA_QNAME = new QName("http://operaciones/", "Calculadora");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculadora_/Calculadora?wsdl");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://operaciones/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://operaciones/", "CalculadoraPort"), Calculadora.class, features);
    }
